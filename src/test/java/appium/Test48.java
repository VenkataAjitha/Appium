...
public class Test48 {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			ta.press(ElementOption.element(e,0,size.getHeight()/2)).waitAction(WaitOptions.waitOptions(Duration.ofSeconds(1))).moveTo(ElementOption.element(e,size.getWidth()-10,size.getHeight()/2)).release().perform();
			Thread.sleep(5000);
			ta.press(ElementOption.element(e,size.getWidth()-10,size.getHeight()/2)).waitAction(WaitOptions.waitOptions(Duration.ofSeconds(1))).moveTo(ElementOption.element(e,0,size.getHeight()/2)).release().perform();
